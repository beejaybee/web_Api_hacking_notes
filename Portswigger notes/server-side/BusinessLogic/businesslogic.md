...
- This includes being aware of how different functions can be combined in unexpected ways. 
...
- For this reason, quirky logic should ideally be fixed even if you can't work out how to exploit it yourself. 
...
4. Due to the relatively unique nature of many logic flaws, it is easy to brush them off as a one-time mistake due to human error and move on. 
